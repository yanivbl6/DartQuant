...
def get_c4_new(nsamples, seed, seqlen, model, hf_token=None, eval_mode=False):
    ...
    if eval_mode:
        ...
        # data_file = hf_hub_download(repo_id="allenai/c4", filename="en/c4-train.00000-of-01024.json.gz", repo_type="dataset")    
        
        # valdata = datasets.load_dataset(
        #     'allenai/c4', 'default-c7bc8b0aefc5e48f', split='validation')
        val_file = hf_hub_download(repo_id="allenai/c4", filename="en/c4-validation.00000-of-00008.json.gz", repo_type="dataset")
        valdata = datasets.load_dataset("json", data_files=val_file, split="train")   
        ...
        train_file = hf_hub_download(repo_id="allenai/c4", filename="en/c4-train.00000-of-01024.json.gz", repo_type="dataset")
