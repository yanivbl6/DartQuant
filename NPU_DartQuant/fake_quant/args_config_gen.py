...
def parser_gen():
    ...
    parser.add_argument('--use_r1', action=argparse.BooleanOptionalAction, default=False,
    ...
    parser.add_argument('--use_r2', type=str, default='none',
    ...
    parser.add_argument('--lm_eval_batch_size', type=str, default='8',
    ...
    setattr(args, 'save_path',
            os.path.join(os.path.dirname(os.path.abspath(__file__)), 'experiments', args.model.split("/")[-1], args.save_name))
